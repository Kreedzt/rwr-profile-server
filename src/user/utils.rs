...
pub fn check_user_in_user_list(
    username: &str,
    data_path: &str) -> Result<bool> {
    let file_name = format!("{}/users.json", data_path);
...
pub fn get_user_id_in_profiles(
    username: &str,
    profile_path: &str) -> Result<bool> {
